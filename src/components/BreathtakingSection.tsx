...
const SLIDES = [
  ...
  },
  {
    ...
    caption:
      "Просто и современно. Драматично и роскошно. Романтично и воздушно. Какой бы стиль вам ни нравился, наша команда Dahlia соединит своё творчество с вашим видением, чтобы ваш день стал похож на сказку.",
  },
  {
